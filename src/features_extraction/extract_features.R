...
source(file.path("src", "features_extraction", "CNVfeatures_functions.R"))
source(file.path("src", "features_extraction", "SVfeatures_functions.R"))
source(file.path("src", "features_extraction", "utils.R"))
...
ex_df <- data.frame(type = rownames(ex_mat), ex_mat, row.names = NULL)
